...
<!-- Custom Theme files -->
    <!-- Bootstrap Styling --> <link rel='stylesheet' href="assets/css/bootstrap.css" type='text/css' />
    <!-- jQuery (necessary for Bootstrap's JavaScript plugins) --> <script src="assets/js/jquery.min.js"></script>
    <!-- Bootstrap-Working-File --> <script src="assets/js/bootstrap.min.js"></script>
    <!-- Index-Page-Styling --> <link rel="stylesheet" href="assets/css/style.css" type="text/css" media="all" />   
	<!-- Owl-Carousel-Styling --> <link rel="stylesheet" href="assets/css/owl.carousel.css" type="text/css" media="all">
<!-- //Custom Theme files -->
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img class="first-slide" src="assets/images/grahaa.jpg" alt="First Slide">
				</div>

				<div class="item">
					<img class="second-slide" src="assets/images/1.jpg" alt="Second Slide">
				</div>
            ...
            <div class="faculty slideanim" id="faculty">
	            ...
	            <div class="col-md-3 col-sm-3 team-top">
						<div class="view view-seventh">
							<a href="#"><img class="img-responsive" src="assets/images/f1.jpg" alt="Wiranto"></a>
					...
					<div class="col-md-3 col-sm-3 team-top team-in">
						<div class="view view-seventh">
							<a href="#"><img class="img-responsive" src="assets/images/f2.jpg" alt="John McCarthy"></a>
					...
					<div class="col-md-3 col-sm-3 team-top">
						<div class="view view-seventh">
							<a href="#"><img class="img-responsive" src="assets/images/f3.jpg" alt="Rudiantara"></a>
					...
					<div class="col-md-3 col-sm-3 team-top top-team">
						<div class="view view-seventh">
							<a href="#"><img class="img-responsive" src="assets/images/f4.jpg" alt="Bill Gates"></a>
